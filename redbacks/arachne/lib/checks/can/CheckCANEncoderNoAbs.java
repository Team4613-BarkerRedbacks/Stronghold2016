 ...
 * @author Sean Zammit
 */
public class CheckCANEncoderNoAbs extends CheckAnalog
{
	CANEncoder sensor;
	 ...
	 */
	public CheckCANEncoderNoAbs(double pulses, CANEncoder sensor) {
	 ...
	 */
	public CheckCANEncoderNoAbs(double pulses, CANEncoder sensor, boolean isGreaterThan) {
		super(isGreaterThan, pulses);
		this.sensor = sensor;
	}

	public boolean isTrue(CommandRB command) {
		return type ? sensor.get() > value : sensor.get() < value;
	}
